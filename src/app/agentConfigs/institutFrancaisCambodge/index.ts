...
// Configure handoffs for agents - they need both tools AND handoff arrays
// Note: We only populate handoffs for non-optimized version when not using optimized agents
if (!useOptimized) {
